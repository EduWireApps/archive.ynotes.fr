<template>
  <header>
    ...
    >
      <div
        class="fixed left-0 w-full shadow-2xl sm:hidden top-16"
      ...
      >
        <div class="px-2 pt-2 pb-3 space-y-1">
          <a
            href="#"
            class="block px-3 py-2 text-base font-medium transition-colors rounded-md "
            :class="topStyle ? 'text-white hover:bg-space-400' : 'text-gray-800 hover:bg-gray-200'"
            >Dashboard</a
          >
        </div>
      </div>
