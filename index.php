...
<body>
    <header class="header hideNotMobile">
        ...
        <div id="ynLogoContainer"> <img src="src/assets/brandLogo.png" class="ynLogo" alt="imgLogo"></div>
    ...
    <div id="completeHeader" class="hideMobile">
        <div id="header">
            <img src="src/assets/brandLogo.png" class="ynLogo" alt="">
    ...
    <div class="section" id="sec1">
        ...
        <div id="presentationTextsContainer">
            ...
            <h1 class="presentation" id="presentationText2">Contrôlez votre contenu en toute <b>sécurité</b></h1>
    ...
    <div class="section" id="sec2">
        ...
        <div class="hiddenInput">
            ...
            <label id="name" class="formLabel"><i>Nous ne vendons pas votre adresse mail.</i></label>
            <div id="btnWithDoneLabel">
                <button id="sendBtn">Envoyer</button>
                <div id="doneLabel">&#10003; C'est fait : nous vous recontacterons d'ici peu !</div>
            </div>
        </div>
        <h3 class="cautionText"><i>L'application bêta peut présenter des problèmes car l'application est encore en phase de développement.</i></h3>
    </div>
        ...
        <div id="storiesContainer">
            ...
            <div class="storyContainer">
                <div id="circleBag" class="circleIllu">
                    <img alt="bag" src="src/assets/bag.png" class="illu" id="bag">
                </div>
            ...
            <div class="storyContainer">
                <div id="circleHashtag" class="circleIllu">
                    <img alt="hashtag" src="src/assets/hashtag.png" class="illu" id="hashtag">
                </div>
            ...
            <div class="storyContainer">
                <div id="circleDove" class="circleIllu">
                    <img alt="dove" src="src/assets/dove.png" class="illu" id="dove">
                </div>
    ...
    <div class="section" id="sec4">
        ...
        <div id="whyChange1">
            <img alt="manthinking" src="src/assets/man.png" id="manAskingHimself" class="hideMobile">
            <div class="rules">
                ...
                <ul id="rulesList">
                    ...
                    <li class="rulesItem">Pas de cookies, de publicités, d'espionnage ou de vente de quoi que ce soit vous concernant. Ce qui est à vous <b>reste à vous.</b></li>
                    <li class="rulesItem">Un doute sur l'utilisation de vos données ? Consultez le code source.</li>
                </ul>

                <button class="skewBtn blue" id="accessPolicyConf" onclick="location.href='files/legal/PDCYNotes.pdf'">Voir la politique de confidentialité en entier</button>
            </div>

        </div>
        <h3 class="cautionText"><i>*Les règles de collecte de données varient lors de l'utilisation de la version bêta de l'application qui possède un dispositif d'envoi automatiques des bugs.</i></h3>
        ...
        <div id="whyChange2">
            ...
            <img alt="machines" src="src/assets/machines.png" id="machines" class="hideMobile">
        </div>
    ...
    <div class="section" id="sec5">
        ...
        <div id="share">
            ...
            <button class="shareBtn" onclick="location.href='mailto:contact@ynotes.fr'">
